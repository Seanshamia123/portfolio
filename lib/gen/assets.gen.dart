...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/de.svg
  String get de => 'assets/icons/de.svg';

  /// File path: assets/icons/es.svg
  String get es => 'assets/icons/es.svg';
  ...
  /// List of all assets
  List<String> get values => [de, es, github, instagram, linkedin, us];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/about_picture.jpeg
  AssetGenImage get aboutPicture =>
      const AssetGenImage('assets/images/about_picture.jpeg');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [aboutPicture, flutter, me];
}
